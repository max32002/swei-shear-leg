...
獅尾快腿黑體基於[思源黑體](https://github.com/adobe-fonts/source-han-sans)的筆觸變斜改造，更加簡明現代化的字體。支援简体中文、繁體中文、韓文與日文；可以免費商用，歡迎大家自由應用、自由優化、自由改作！
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-shear-leg@2.1/WebFont/CJK%20TC/SweiShearLegCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-shear-leg@2.1/WebFont/CJK%20TC/SweiShearLegCJKtc-Regular.woff) format("woff");
}
```
